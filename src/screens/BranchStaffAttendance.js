...
function BranchStaffAttendance({ navigation}) {
...
async function getdata() {
  ...
  setNoData(false);
  await fetch(
    `https://soop.io/api/v1/school_owner/staff_attendances/${myid}?date=${x}&branch_id=${myBid}`,
    {
      method: "GET",
    }
  )
...
export default BranchStaffAttendance;
